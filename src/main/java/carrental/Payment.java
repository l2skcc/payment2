...
public class Payment {
    ...
    public void onPrePersist() {
        if ("PAID".equals(this.getProcStatus())) {
            ...
            carrental.external.Star star = new carrental.external.Star();
            // mappings goes here
            star.setId(paid.getId());
            star.setResrvNo(paid.getResrvNo());
            star.setCarNo(paid.getCarNo());
            star.setStars("w");
            PaymentApplication.applicationContext.getBean(carrental.external.StarService.class).star(star);
        }
